...
import (
	...
	"github.com/arnabghose997/compchain/docs"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		compchainmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	CompchainKeeper compchainmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.CompchainKeeper = *compchainmodulekeeper.NewKeeper(
		appCodec,
		keys[compchainmoduletypes.StoreKey],
		keys[compchainmoduletypes.MemStoreKey],
		app.GetSubspace(compchainmoduletypes.ModuleName),
	)
	compchainModule := compchainmodule.NewAppModule(appCodec, app.CompchainKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		compchainmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(compchainmoduletypes.ModuleName)
